...
class FollowerViewModel : ViewModel() {
    val listUsersFollowerNonMutable = ArrayList<UsersItem>()
    val listUsersFollowers = MutableLiveData<ArrayList<UsersItem>>()
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(
                ...
                try {
                    ...
                    listUsersFollowerNonMutable.add(userItems)
                    listUsersFollowers.postValue(listUsersFollowerNonMutable)
                } catch (e: Exception) {
                    Toast.makeText(context, e.message, Toast.LENGTH_SHORT).show()
                    e.printStackTrace()
                }
    ...
    fun getFollowers() : LiveData<ArrayList<UsersItem>> {
